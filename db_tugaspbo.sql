...
insert  into `tbl_peminjaman`(`id`,`namaTeman`,`barangPinjam`) values (1,'Deri','Kosmetik'),(2,'Teguh','Sabun Nuvo'),(3,'Hari','Tisu'),(4,'Rizki','Gitar'),(5,'Dwi','Kipas'),(6,'Afif','Mouse'),(7,'Satria','Motor');
